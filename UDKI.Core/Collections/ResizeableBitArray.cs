...
internal struct ResizeableBitArray
{
    ...
    public ResizeableBitArray(int[] data, int numBits)
    {
        Data = new ValueList<int>(data);
        NumBits = numBits;
    ...
    {
        private ref ResizeableBitArray array;
        private int idx = -1;

        public Enumerator(ref ResizeableBitArray bitArray)
        {
             array = ref bitArray;
        }

        /// <inheritdoc />
        public bool Current => array[idx];
